...
print 'time to create starting population:', end - start
"""


# Loop the following

# Attention: starting_pop
#starting_pop = read('cluster_{0}.traj'.format(i))


# Modify from here
# create the database to store information in
starting_pop = 'cluster_{0}.traj'.format(n)
...
write('all_candidates_in_cluster{0}.traj'.format(n), da.get_all_relaxed_candidates())
